...
namespace GSeries.Filesystem {
  ...
  /// </summary>
  public class FuseFilesys : FileSystem, IFilesys {
    ...
    readonly GatorShareRedirectFSHelper _rfs;
    #endregion
    ...
    #region Constructors
    public FuseFilesys(string mountPoint, string shadowDirPath, GatorShareRedirectFSHelper 

...
namespace GatorShare.Filesystem {
  ...
  /// </summary>
  public class FilesysEventArgs : EventArgs {
  ...
  /// </summary>
  public class ReadFileEventArgs : FilesysEventArgs {
    #region Fields
  ...
  /// </summary>
  public class OpenFileEventArgs : FilesysEventArgs {
    readonly IntPtr _handle;
  ...
  /// </summary>
  public class ReleaseFileEventArgs : FilesysEventArgs {
    readonly IntPtr _handle;
  ...
  /// </summary>
  public class GetPathStatusEventArgs : FilesysEventArgs {

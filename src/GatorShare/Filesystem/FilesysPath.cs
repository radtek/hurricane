...
namespace GatorShare.Filesystem {
  ...
  public abstract class FilesysPath {
    ...
    /// <summary>
    /// Performs an explicit conversion from <see cref="GatorShare.Filesystem.FilesysPath"/> 
  ...
  public class VirtualRawPath : VirtualPathBase {
    ...
    /// <summary>
    /// Performs an explicit conversion from <see cref="GatorShare.Filesystem.VirtualRawPath"/> 
    /// to <see cref="GatorShare.Filesystem.VirtualPath"/>.
    /// </summary>

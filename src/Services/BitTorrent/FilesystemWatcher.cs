...
namespace Fushare.BitTorrent {
  ...
  class FilesystemWatcher {
    private static IDictionary _log_props = Logger.PrepareLoggerProperties(typeof(FilesystemWatcher));

    public static void SetupTorrentWatcher(BitTorrentManager manager, string torrentsDir) {
      TorrentFolderWatcher watcher = new TorrentFolderWatcher(torrentsDir, "*.torrent");

...
namespace GSeries.Filesystem {
  ...
  public interface IFilesysEventHandler {
    ...
    /// <param name="args">The 
    /// <see cref="GSeries.Filesystem.GetPathStatusEventArgs"/> 
    ...
    /// <param name="sender">The sender.</param>
    /// <param name="args">The 
    /// <see cref="GSeries.Filesystem.ReleaseFileEventArgs"/> instance containing 
    ...
    /// <param name="sender">The sender.</param>
    /// <param name="args">The 
    /// <see cref="GSeries.Filesystem.ReadFileEventArgs"/> instance containing the 
    /// event data.</param>
    ...
    /// </summary>
    /// <param name="sender">The sender.</param>
    /// <param name="args">The <see cref="GSeries.Filesystem.OpenFileEventArgs"/> 
    /// instance containing the event data.</param>
